// Define SVG area dimensions. Here is where we are setting up the page
var svgWidth = 960;
var svgHeight = 500;

// Define the chart's margins as an object. arbitrary numbers, just play arround with them
var margin = {
  top: 60,
  right: 60,
  bottom: 120,
...
// Define dimensions of the chart area. This is where youll be plotting your charts
var chartWidth = svgWidth - margin.left - margin.right;
var chartHeight = svgHeight - margin.top - margin.bottom;

// Select scatter, append SVG area to it, and set its dimensions
var svg = d3.select("#scatter")//the type of plot we want
  .append("svg")
  .classed("chart", true)
  .attr("width", svgWidth)
  .attr("height", svgHeight);

// shift everything over by the margins. This is where we are flipping the chart to the normal x and y axis location we are used to.
